...
EventBuilder::EventBuilder(){
  ...
  highEnergyLostFEEs = new TH1D("highEnergyLostFEEs","",24,1,24);
#endif
#ifdef OFFSETS
...
void EventBuilder::CloseEvent(){
  ...
  if(implantEvents.size() ==1){
    highEnergyLostFEEs->Fill(implantEvents.front().GetFEE64ID());
  }
