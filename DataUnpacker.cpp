...
bool DataUnpacker::UnpackWords(std::pair < unsigned int, unsigned int> wordsIn){
	...
	if (dataType ==3 ){
		...
		if (timestampWR48Status && timestampWR64Status && correlationScalerStatus){//If timestampMSB has been obtained from inforation data set the timestamp of the adc data
